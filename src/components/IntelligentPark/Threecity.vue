...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      video.src = "IntelligentPark/bi.mp4"; // 设置视频地址
      ...
      let isopen = false
      let tiemen = {}
      modeloader.loadModelToScene('IntelligentPark/city-v1.glb', _model => {
      ...
      modeloader.loadModelToScene('IntelligentPark/zuo.glb', _model => {
        office = _model
      ...
      modeloader.loadModelToScene('IntelligentPark/75.gltf', _model => {
        _model.openCastShadow()
        _model.openReceiveShadow()
      ...
      modeloader.loadModelToScene('IntelligentPark/billboard_-_lowpoly.glb', _model => {
        _model.openCastShadow()
        ...
        let box = _model.getBox()
        modeloader.loadModelToScene('IntelligentPark/drone/wrj.glb', res => {
          res.openCastShadow()
      ...
      modeloader.loadModelToScene('IntelligentPark/car13.gltf', _model => {
        che = _model
        _model.openCastShadow()
        _model.openReceiveShadow()
      ...
      modeloader.loadModelToScene('IntelligentPark/ren.glb', _model => {
        _model.openCastShadow()
      ...
      modeloader.loadModelToScene('IntelligentPark/tree_animate/scene.gltf', _model => {
        _model.openCastShadow()
