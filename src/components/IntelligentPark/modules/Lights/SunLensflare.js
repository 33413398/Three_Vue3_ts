...
export default class SunLensflare {
  ...
  constructor (_viewer) {
    ...
    this.textureFlare0 = textureLoader.load('IntelligentPark/resources/lensflare/lensflare0.png')
    this.textureFlare3 = textureLoader.load('IntelligentPark/resources/lensflare/lensflare3.png')
  }
