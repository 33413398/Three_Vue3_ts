...
import earthVertex from '@/components/Earth/shaders/earth/vertex.vs?raw'; // GLSL代码文件导入需要加入?raw即可解决报错问题
import earthFragment from '@/components/Earth/shaders/earth/fragment.fs?raw';
