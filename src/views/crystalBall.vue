...
// @ts-ignore
import { CCDIKSolver, CCDIKHelper } from '../../public/jsm/animation/CCDIKSolver.js';
...
let mirrorSphereCamera: any = null
const OOI: any = {}
let IKSolver: any = null
let stats: any = null
let gui: any = null
let conf: any = null
...
async function init() {
  ...
  const gltf = await gltfLoader.loadAsync('gltf/kira.glb');
...
function updateIK() {
  ...
  scene.traverse(function (object: any) {
    if (object.isSkinnedMesh){
      object?.computeBoundingSphere&&object.computeBoundingSphere();
    }
  });
}
